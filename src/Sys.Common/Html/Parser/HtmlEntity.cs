namespace iPortal.Common.Html.Parser
{
    ...
    {
        private static Hashtable _entityName = new Hashtable();
        private static Hashtable _entityValue = new Hashtable();
        ...
        public static string DeEntitize(string text)
        {
            ...
            Label_00A0:
                if (builder2[0] == '#')
                {
                    ...
                    try
                    {
                        int num2 = Convert.ToInt32(str.Substring(1, str.Length - 1));
                        builder.Append(Convert.ToChar(num2));
                    }
                    catch
                    {
                        builder.Append("&#" + str + ";");
        ...
        {
            foreach (HtmlAttribute attribute in collection)
            {
        ...
        public static string Entitize(string text, bool useNames, bool entitizeQuotAmpAndLtGt)
        {
            ...
            for (int i = 0; i < text.Length; i++)
            {
                ...
                {
                    string str = _entityName[num2] as string;
